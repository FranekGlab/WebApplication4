    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            using (var serviceScope = app.ApplicationServices.CreateScope())
            {
                ...
                {
                    databaseScope.People.Add(new PersonEntity("Jan", "Kowalski", PersonGender.MALE));
                    databaseScope.People.Add(new PersonEntity("Ania", "Kowalska", PersonGender.FEMALE));
                    databaseScope.People.Add(new PersonEntity("XYZ", "YZTZT", PersonGender.NOT_SPECIFIED));
                    databaseScope.People.Add(new PersonEntity("Andrzej", "Bazodanowy", PersonGender.MALE));
